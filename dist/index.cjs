...
__publicField$4(_StrUtil, "isEmpty", (val) => {
  if (shared.isString(val))
    return val.length === 0;
  else if (shared.isSymbol(val) && val.description)
...
exports.TIME_CATEGORY = TIME_CATEGORY;
